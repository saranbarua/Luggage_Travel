          ...
          <div>
            <Reveal>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 tracking-tight">
                Let's plan your{" "}
                <span className="text-indigo-600">next journey</span>.
              </h2>
            </Reveal>
            <Reveal delay={0.1}>
              <p className="text-gray-500 text-lg mb-12">
                Questions about visas or flight availability? Our team is ready
                to assist you. Visit our office for a face-to-face consultation.
              </p>
            </Reveal>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">
                      31 D. T. Road, Kadamtoli, Alamgir Banijjya Bitan, 1st
                      Floor, 4000 4000 Chittagong, Bangladesh
                    </p>
                  </div>
                </div>
              </Reveal>
              ...
              {submitted ? (
                <div className="text-center py-12 flex flex-col items-center">
                  ...
                  <p className="text-gray-500 mb-8">
                    Thank you for reaching out. One of our travel consultants
