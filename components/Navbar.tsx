...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "glass border-b border-gray-200/50 py-3" : "bg-transparent py-5"}`}
    >
